...
public class User_pssd extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_pssd);
                        ...
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                ...
                                if(task.isSuccessful()){
                                    Toast.makeText(User_pssd.this, "Correo enviado", Toast.LENGTH_LONG).show();
                                }else{
                                    Toast.makeText(User_pssd.this, task.getException().getMessage(), Toast.LENGTH_LONG).show();
                                }
                            }
                        });
            }
    ...
    private void backiniciarsesion(){
        Intent iback = new Intent(this, Login.class);
        startActivity(iback);
        finish();
    }
}
